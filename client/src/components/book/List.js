...
class List extends Component {
  ...
  pagination() {
    ...
    previous = previous ? paginationStringForFrontEnd(previous, 'books') : null;
    next = next ? paginationStringForFrontEnd(next, 'books') : null;
    last = paginationStringForFrontEnd(last, 'books');
